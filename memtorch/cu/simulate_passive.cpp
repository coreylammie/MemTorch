...
void simulate_passive_bindings(py::module_ &m) {
  ...
  m.def(
      "simulate_passive",
      [&](at::Tensor conductance_matrix, at::Tensor device_matrix, float rel_tol,
      ...
      py::arg("conductance_matrix"), py::arg("device_matrix"), py::arg("rel_tol")=0.1,
  ...
  m.def(
      ...
      [&](at::Tensor conductance_matrix, at::Tensor device_matrix, float rel_tol,
        ...
        return simulate_passive_linearIonDrift(conductance_matrix, device_matrix, rel_tol,
          pulse_duration, refactory_period,  pos_voltage_level,  neg_voltage_level,
          timeout, force_adjustment, force_adjustment_rel_tol, force_adjustment_pos_voltage_threshold,
   ...
   m.def(
      ...
      [&](at::Tensor conductance_matrix, at::Tensor device_matrix, float rel_tol,
        ...
        return simulate_passive_VTEAM(conductance_matrix, device_matrix, rel_tol,
          pulse_duration, refactory_period,  pos_voltage_level,  neg_voltage_level,
          timeout, force_adjustment, force_adjustment_rel_tol, force_adjustment_pos_voltage_threshold,
   ...
   m.def(
      ...
      [&](at::Tensor conductance_matrix, at::Tensor device_matrix, float rel_tol,
        ...
        return simulate_passive_Stanford_PKU(conductance_matrix, device_matrix, rel_tol,
          pulse_duration, refactory_period,  pos_voltage_level,  neg_voltage_level,
          timeout, force_adjustment, force_adjustment_rel_tol, force_adjustment_pos_voltage_threshold,
