...
class Conv3d(nn.Conv3d):
    ...
    def __init__(self, convolutional_layer, memristor_model, memristor_model_params, mapping_routine=naive_map, transistor=True, programming_routine=None,
                    programming_routine_params={}, p_l=None, scheme=memtorch.bh.Scheme.DoubleColumn, tile_shape=None,
    ...
    def forward(self, input):
        ...
        if self.forward_legacy_enabled:
            ...
            for batch in range(input.shape[0]):
                ...
                if hasattr(self, 'non_linear') or self.ADC_resolution is not None:
                    batch_input = batch_input = convert_range(batch_input, batch_input.min(), batch_input.max(), -1, 1)
                ...
                if hasattr(self, 'non_linear'):
                    ...
                    if hasattr(self, 'simulate'):
                        ...
                        tiles_map=tiles_map, crossbar_shape=crossbar_shape,
